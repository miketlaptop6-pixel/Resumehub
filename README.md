<div align="center">
  <a href="https://resumehub.in">
    <img src="apps/web/public/opengraph/banner.jpg" alt="ResumeHub.in" />
  </a>

  <h1>ResumeHub.in</h1>

  <p>ResumeHub.in is a free and open-source resume builder that simplifies the process of creating, updating, and sharing your resume.</p>

  <p>
    <a href="https://resumehub.in"><strong>Get Started</strong></a>
    ·
    <a href="https://docs.resumehub.in"><strong>Learn More</strong></a>
  </p>

  <p>
    <img src="https://img.shields.io/github/package-json/v/amruthpillai/reactive-resume?style=flat-square" alt="ResumeHub.in Version">
...
ResumeHub.in makes building resumes straightforward. Pick a template, fill in your details, and export to PDF—no account required for basic use. For those who want more control, the entire application can be self-hosted on your own infrastructure.

Built with privacy as a core principle, ResumeHub.in gives you complete ownership of your data. The codebase is fully open-source under the MIT license, with no tracking, no ads, and no hidden costs.
...
The quickest way to run ResumeHub.in locally:
...
For detailed setup instructions, environment configuration, and self-hosting guides, see the [documentation](https://docs.resumehub.in).
...
Comprehensive guides are available at [docs.resumehub.in](https://docs.resumehub.in):

| Guide                                                                        | Description                      |
| ---------------------------------------------------------------------------- | -------------------------------- |
| [Getting Started](https://docs.resumehub.in/getting-started)                    | First-time setup and basic usage |
| [Self-Hosting](https://docs.resumehub.in/self-hosting/docker)                   | Deploy on your own server        |
| [Development Setup](https://docs.resumehub.in/contributing/development)         | Local development environment    |
| [Project Architecture](https://docs.resumehub.in/contributing/architecture)     | Codebase structure and patterns  |
| [Exporting Your Resume](https://docs.resumehub.in/guides/exporting-your-resume) | PDF and JSON export options      |

## Self-Hosting

ResumeHub.in can be self-hosted using Docker. The stack includes:
...
See the [self-hosting guide](https://docs.resumehub.in/self-hosting/docker) for complete instructions.

## Support

ResumeHub.in is and always will be free and open-source. If it has helped you land a job or saved you time, please consider supporting continued development:
...
See the [development setup guide](https://docs.resumehub.in/contributing/development) for detailed instructions on how to set up the project locally.
