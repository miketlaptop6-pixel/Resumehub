	...
	return (
		<section id="prefooter" className="relative overflow-hidden py-16 md:py-24">
			...
			<div className="relative space-y-8">
				<TextMaskEffect aria-hidden="true" text="ResumeHub.in" className="hidden md:block" />
				...
				>
					...
					<p className="text-muted-foreground leading-relaxed">
						<Trans>
							ResumeHub.in continues to grow thanks to its vibrant community. This project owes its progress to
